...
const STUDENTS_SCHEDULE: DaySchedule[] = [
  ...
  },
  {
    ...
    events: [
      ...
      { time: "15:15 – 16:30", activity: "Lab safety instructions (New Uzbekistan hotels)" },
      { time: "16:30 – 19:00", activity: "Free time / Interactive games (New Uzbekistan hotels)" },
  ...
  },
  {
    ...
    events: [
      ...
      { time: "14:30 – 19:00", activity: "Free time / Workshops: Handcrafted ceramic & Acrylic painting / Interactive games" },
      { time: "19:00 – 20:30", activity: "Dinner (New Uzbekistan hotels)" },
      { time: "20:30 – 23:00", activity: "Free time" },
    ],
  },
...
const MENTORS_SCHEDULE: DaySchedule[] = [
  ...
  },
  {
    ...
    events: [
      ...
      { time: "14:30 – 18:00", activity: "Consultation with the Problem Authors (Wyndham Hotel)" },
      { time: "19:00 – 20:30", activity: "Dinner (Wyndham Hotel)" },
