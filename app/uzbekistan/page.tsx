                ...
                <div className="space-y-16">
                  ...
                  <div className="text-center max-w-4xl mx-auto">
                    ...
                    <p className="text-xl text-slate-600 leading-relaxed mb-12">
                      Uzbekistan's vibrant capital city, where ancient history
                      meets cutting-edge science. Tashkent offers world-class
                      venues, excellent connectivity, and rich cultural
                      experiences for all IChO 2026 participants.
                    </p>
                  </div>
                  ...
                  <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
                    {tashkentFacts.map((fact, index) => (
                      <div
                        key={index}
                        className="text-center p-6 bg-white rounded-2xl shadow-lg border border-slate-100 hover:shadow-xl transition-all duration-300 hover:scale-105"
                      >
                  ...
                  <div className="bg-gradient-to-r from-emerald-50 to-sky-50 rounded-3xl p-8 md:p-12">
                    <div className="max-w-4xl mx-auto text-center">
                      ...
                      <p className="text-lg text-slate-600 leading-relaxed mb-8">
                        IChO 2026 will be hosted at state-of-the-art facilities
                        in Tashkent, featuring modern laboratories, auditoriums,
                        and accommodation designed to provide the perfect
                        environment for scientific excellence.
                      </p>
                      <div className="grid md:grid-cols-3 gap-6">
                        <div className="bg-white rounded-2xl p-6 shadow-lg">
                          ...
                          <p className="text-slate-600">
                            Fully equipped chemistry laboratories with
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg">
                          ...
                          <p className="text-slate-600">
                            Spacious venues for ceremonies and academic
                            presentations
                          </p>
                        </div>
                        <div className="bg-white rounded-2xl p-6 shadow-lg">
                          ...
                          <p className="text-slate-600">
                            Comfortable lodging with international standards
                          </p>
                        </div>
                      </div>
                    </div>
                ...
                <div className="space-y-16">
                  ...
                  <div className="text-center max-w-4xl mx-auto mb-16">
                    ...
                    <p className="text-xl text-slate-600 leading-relaxed">
                      Everything you need to know for a smooth and enjoyable
                      ...
                      <div className="space-y-6">
                        <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100">
                          ...
                          <p className="text-slate-600 mb-4">
                            Tourist visas available online or on arrival for
                            most countries. Special arrangements for IChO
                            participants.
                          </p>
                          <Link
                            href="https://gov.uz/en/mfa/activity_page/o-zbekiston-respublikasi-vizasi"
                            target="_blank"
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100">
                          ...
                          <p className="text-slate-600">
                            July offers warm, pleasant weather perfect for
                            exploration. Average temperature: 25-30°C (77-86°F).
                          </p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100">
                          ...
                          <p className="text-slate-600">
                            Uzbek Som (UZS). Credit cards widely accepted.
                            Currency exchange available at airports and banks.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-8">
                      ...
                      <div className="space-y-6">
                        <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100">
                          ...
                          <p className="text-slate-600 mb-4">
                            Modern metro system, taxis, and organized transport
                            for IChO participants. Airport transfers provided.
                          </p>
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100">
                          ...
                          <p className="text-slate-600">
                            Free WiFi at venues. International roaming
                            available. English widely spoken in tourist areas.
                          </p>
                        </div>
                        ...
                        <div className="bg-white rounded-2xl p-6 shadow-lg border border-slate-100">
                          ...
                          <p className="text-slate-600">
                            Uzbekistan is very safe for tourists. Standard
                            vaccinations recommended. Medical facilities
                            available.
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="grid md:grid-cols-2 gap-8">
                        <div>
                          ...
                          <ul className="space-y-3 text-slate-600">
                            ...
                            <li>
                              • Accept hospitality graciously - it's a cultural
                              tradition
                            </li>
                            <li>
                              • Learn basic Uzbek greetings - locals appreciate
                              the effort
                            </li>
                            <li>
                              • Try local cuisine - it's an important part of
                              the culture
                            </li>
                          </ul>
                        </div>
                        <div>
                          ...
                          <ul className="space-y-3 text-slate-600">
                            <li>
                              • Friday is the holy day (similar to Sunday in
                              Christianity)
                            </li>
                            <li>• Shoes are removed when entering homes</li>
                            <li>
                              • Handshakes are common, but wait for women to
                              extend their hand first
                            </li>
                            <li>
                              • Photography may be restricted at some historical
                              sites
                            </li>
                          </ul>
                        </div>
        ...
        <section className="py-20 bg-gradient-to-r from-emerald-600 to-sky-600">
          <div className="max-w-4xl mx-auto text-center px-4 sm:px-6 lg:px-8">
            ...
            <p className="text-xl text-emerald-100 mb-8 leading-relaxed">
              Join us in Tashkent for an unforgettable journey of scientific
